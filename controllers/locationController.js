...
//HOME LOCATION
export const createHomeLoc = catchAsyncError(async (req, res, next) => {
...
//WORK LOCATION
export const createWorkLoc = catchAsyncError(async (req, res, next) => {
	const { floorNo, apartmentNo, streetAddress, latlong, area, phone } =
		req.body;
	const userId = req.user.id;
...
//LOCATION
export const createLoc = catchAsyncError(async (req, res, next) => {
	const { floorNo, apartmentNo, streetAddress, latlong, area, phone } =
		req.body;
	const userId = req.user.id;
