...
export default function Header() {
	const styles = {
		wrapper: "relative overflow-hidden h-fit z-[10] w-full  flex",
			...
			<div className={styles.wrapper}>
				<div className={styles.textbox}>
					...
					<div className={styles.subHeading}>
						Recipes that are carefully crafted with fresh, locally
						sourced ingredients and made with love in our very own
						kitchen.
					</div>
