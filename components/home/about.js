...
export default function About() {
	const styles = {
		...
		aboutTitle: "text-heading-lg text-primary-text",
			...
			<div className={styles.aboutSection}>
				...
				<div className={styles.aboutTextBox}>
					...
					<div className={styles.aboutDetails}>
						We use no artificial flavours, colours, or
						preservatives, making our food the perfect choice for
						health-conscious individuals. Our commitment to quality
						and taste ensures that every dish will leave you feeling
						nourished and energized.
						<br />
						<br />
						We offer a variety of tasty and healthy options that are
